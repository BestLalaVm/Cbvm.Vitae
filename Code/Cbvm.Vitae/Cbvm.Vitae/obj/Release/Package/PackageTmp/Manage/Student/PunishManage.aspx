<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="PunishManage.aspx.cs" Inherits="Cbvm.Vitae.Manage.Student.PunishManage" %>
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
                        <a href='PunishDetail.aspx?ID=<%#Eval("ID") %>' title="查看" class="grid-edit">
                            <span>查看</span>
                        </a>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
