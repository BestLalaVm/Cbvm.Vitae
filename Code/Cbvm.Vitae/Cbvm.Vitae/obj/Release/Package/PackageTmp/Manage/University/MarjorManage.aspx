<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="MarjorManage.aspx.cs" Inherits="Cbvm.Vitae.Manage.College.MarjorManage"  Theme="CollegeManage"%>
    ...
    <telerik:RadGrid ID="grdTeacherGroup" runat="server" OnItemDataBound="radGrid_ItemDataBound"
        ...
        <MasterTableView DataKeyNames="Code" AllowCustomPaging="True" AllowPaging="True">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Name" HeaderText="专业名称">
                ...
                <FormTemplate>
                    <div class="data-detail">
                        ...
                        <div class="container">
                            <table>
                                <tr>
                                    <th valign="top"><span class="required">专业名称</span>:</th>
                                    <td>
                                        <asp:TextBox ID="txtName" runat="server" Width="240px" CssClass="edit-text" MaxLength="200"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <td>
                                        <asp:RequiredFieldValidator runat="server" ID="rqvName" ControlToValidate="txtName" Display="Dynamic" ErrorMessage="<span class='required'>专业名称不能为空</span>"></asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                    <th valign="top">专业描述:</th>
                                    <td>
                                        <asp:TextBox ID="txtDescription" MaxLength="500" runat="server" TextMode="MultiLine" Width="400px" Height="60" CssClass="edit-text"></asp:TextBox>
                                    </td>
                                </tr>
                            </table>
                        </div>
