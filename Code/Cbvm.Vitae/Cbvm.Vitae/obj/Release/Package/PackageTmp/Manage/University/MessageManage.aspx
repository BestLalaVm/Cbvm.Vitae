<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true"
    CodeBehind="MessageManage.aspx.cs" Inherits="Cbvm.Vitae.Manage.University.MessageManage" Theme="UniversityManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceAction" runat="server">
    <div class="left">
        ...
        <asp:Button ID="btnDelete" runat="server" OnClick="btnDelete_Click" Text="删除" ></asp:Button>
        <asp:Button ID="btnTop" runat="server" OnClick="btnTop_Click" Text="置顶"></asp:Button>
    </div>
    <div class="right">
    ...
    <telerik:RadGrid ID="grdMessage" runat="server" AutoGenerateColumns="false" OnItemDataBound="grdMessage_ItemDataBound"
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="置顶">
                    <HeaderStyle HorizontalAlign="Left" Width="50px" />
                    <ItemStyle HorizontalAlign="Left" Width="50px" />
                    <ItemTemplate>
                        <asp:CheckBox ID="chkIsTop" runat="server" Checked='<%#Eval("IsTop") %>' OnCheckedChanged="chkIsTop_CheckedChanged"
                            AutoPostBack="true" />
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                <telerik:GridDateTimeColumn DataField="IsTopTime" HeaderText="置顶时间" DataFormatString="{0:yyyy-MM-dd H:m:ss}">
                    <HeaderStyle HorizontalAlign="Left" Width="150px" />
                    <ItemStyle HorizontalAlign="Left" Width="150px" />
                </telerik:GridDateTimeColumn>
                <telerik:GridBoundColumn DataField="CategoryName" HeaderText="类别">
                ...
                <telerik:GridTemplateColumn HeaderText="标题">
                    ...
                    <ItemTemplate>
                        <a href="<%#Eval("Link") %>" style="text-decoration:underline;" target="_blank"><%#Eval("Title") %></a>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
                ...
                <FormTemplate>
                    <div class="data-detail">
                        ...
                        <div class="container">
                            <table>
                                <tr>
                                    <th>类别:<span class="required">*</span>
                                    </th>
                                    <td>
                                        <asp:DropDownList ID="drp_Category_" runat="server" Width="200px" Enabled="false"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="rqvCategory" runat="server" ControlToValidate="drp_Category_"
                                            Display="Dynamic" ValidationGroup="message" ErrorMessage="<img src='/Image/invalid.gif' title='类别不能为空!' />"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CheckBox ID="chkIsImportant" runat="server" Text="重要通知" />&nbsp;&nbsp;<asp:CheckBox ID="chkIsTop" runat="server" Text="置顶" />
                                    </td>
                                </tr>
                            </table>
                        </div>
