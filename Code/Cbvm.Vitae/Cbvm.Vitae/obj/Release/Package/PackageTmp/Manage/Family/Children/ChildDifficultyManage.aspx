<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="ChildDifficultyManage.aspx.cs" Inherits="Cbvm.Vitae.Manage.Family.Children.ChildDifficultyManage" %>
    ...
    <telerik:RadGrid ID="grdActivity" runat="server" OnNeedDataSource="radGrid_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Title" HeaderText="困难认定标题">
                ...
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
                        <a href='ChildDifficultyDetail.aspx?ID=<%#Eval("ID") %>' title="查看" class="grid-edit">
                            <span>查看</span>
                        </a>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
