<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="FellowshipManage.aspx.cs" Inherits="Cbvm.Vitae.Manage.College.FellowshipManage" %>
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
                        <a href='FellowshipDetail.aspx?ID=<%#Eval("ID") %>' title="编辑" class="grid-edit">
                            <span>编辑</span>
                        </a>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
