<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="EnterpriseJobList.aspx.cs" Inherits="Cbvm.Vitae.Manage.Student.EnterpriseJobList" %>
...
<%--                        <a href='#' title="申请职位" onclick="RequestNewJob('<%#Eval("Code") %>')" class="grid-edit">
                        ...
                        <a href='RequestNewJob.aspx?jobCode=<%#Eval("Code") %>' title="申请职位" class="grid-edit">
                            <span>申请职位</span>
                        </a>
                    </ItemTemplate>
