<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true"
    CodeBehind="StudentActivityList.aspx.cs" Inherits="Cbvm.Vitae.Manage.Student.StudentActivityList"  Theme="StudentManage"%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="contentPlaceList" runat="server">
    ...
    <script type="text/javascript">
        function OpenPublishActivityList() {
            parent.ShowIframeForm("应用发布活动", "/Manage/Common/PublishActivityList.aspx?StudentNum=<%=StudentNum %>", "950px", "520px");
        }
    </script>
</asp:Content>
