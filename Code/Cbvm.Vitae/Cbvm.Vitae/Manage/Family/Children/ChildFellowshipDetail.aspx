<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterDetail.master" AutoEventWireup="true" CodeBehind="ChildFellowshipDetail.aspx.cs" Inherits="Cbvm.Vitae.Manage.Family.Children.ChildFellowshipDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceDetail" runat="server">
    <uc:assessmentDetail id="uc_assessment_" runat="server"  SourceAssessType="Fellowship"  RedirectListPage="FellowshipManage.aspx" Caption="助学金明细"/>
</asp:Content>
