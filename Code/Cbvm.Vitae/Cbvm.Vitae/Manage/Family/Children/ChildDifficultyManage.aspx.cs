...
{
    public partial class ChildDifficultyManage : BaseFamilyListPage<AssessmentPresentation, AssessmentCriteria>
    {
        ...
        {
            Response.Redirect("ChildDifficultyDetail.aspx");
        }
        ...
        {
            criteria.AssessType = AssessType.DifficultyIdentified;
