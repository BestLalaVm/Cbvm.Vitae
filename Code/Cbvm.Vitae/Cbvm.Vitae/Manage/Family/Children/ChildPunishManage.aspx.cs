...
{
    public partial class ChildPunishManage : BaseFamilyListPage<AssessmentPresentation, AssessmentCriteria>
    {
        ...
        {
            Response.Redirect("ChildPunishDetail.aspx");
        }
        ...
        {
            criteria.AssessType = AssessType.Punishment;
