<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="StudentExercitationVerifyList.aspx.cs" Inherits="Cbvm.Vitae.Manage.Teacher.StudentExercitationVerifyList" %>
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridTemplateColumn HeaderText="通过">
                    <ItemTemplate>
                        <asp:CheckBox ID="chkIsPassed" runat="server" Enabled="false"
