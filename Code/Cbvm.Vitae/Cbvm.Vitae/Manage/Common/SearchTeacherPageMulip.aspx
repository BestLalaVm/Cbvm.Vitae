<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/ThickBox.Master" AutoEventWireup="true" CodeBehind="SearchTeacherPageMulip.aspx.cs" 
    Inherits="Cbvm.Vitae.Manage.Common.SearchTeacherPageMulip" Theme="BaseManage"%>
        ...
        <MasterTableView DataKeyNames="TeacherNum" PageSize="20">
            <Columns>
                <telerik:GridTemplateColumn>
                    ...
                    <ItemTemplate>
                        <asp:CheckBox runat="server" ID="chkTeacher" Checked='<%#DataBinder.Eval(Container,"DataItem.Selected") %>' />
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
