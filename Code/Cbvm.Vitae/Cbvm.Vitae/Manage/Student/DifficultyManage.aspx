<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="DifficultyManage.aspx.cs" 
    Inherits="Cbvm.Vitae.Manage.Student.DifficultyManage" %>
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
                        <a href='DifficultyDetail.aspx?ID=<%#Eval("ID") %>' title="查看" class="grid-edit">
                            <span>查看</span>
                        </a>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
