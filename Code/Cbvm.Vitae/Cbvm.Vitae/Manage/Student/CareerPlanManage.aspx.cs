...
{
    public partial class CareerPlanManage : BaseStudentListPage<StudentCareerPlanPresentation, StudentCareerPlanCriteria>
    {
        ...
        {
            Response.Redirect("CareerPlanDetail.aspx");
        }
