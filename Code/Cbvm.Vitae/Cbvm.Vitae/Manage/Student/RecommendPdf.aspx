<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterDetail.master" AutoEventWireup="true" CodeBehind="RecommendPdf.aspx.cs" Inherits="Cbvm.Vitae.Manage.Student.RecommendPdf" Theme="StudentManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPlaceDetail" runat="server">
    <div class="recommend-preview user-recommend">
        <div class="page1 page">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 940px;" class="table-left">
                ...
                <tr>
                    ...
                    <td colspan="8">
                        <span class="label" style="width: 50px;">手    机:</span><span><asp:TextBox ID="txt_Telephone_" runat="server" CssClass="customize-text" Width="200px"></asp:TextBox></span>
                        <span class="label">家庭电话:</span><span><asp:TextBox ID="txt_HomePhone_" runat="server" CssClass="customize-text" Width="200px"></asp:TextBox></span>
                        <span class="label">E－mail:</span><span><asp:TextBox ID="txt_Email_" runat="server" CssClass="customize-text" Width="200px"></asp:TextBox></span>
                    </td>
                </tr>
                <tr>
                    <td colspan="8">
                        <span class="label">家庭地址:</span><span><asp:TextBox ID="txt_HomeAddress_" runat="server" CssClass="customize-text home-address" Width="320px"></asp:TextBox></span>
                        <span class="label">邮  编 :</span><span><asp:TextBox ID="txt_PostCode_" runat="server" CssClass="customize-text" Width="200px"></asp:TextBox></span>
                    </td>
                </tr>
                <tr>
                    <th>专    长</th>
        ...
        <div class="page2 page">
            <div class="table-left table" style="top: 1381px; height: ">
                <div style="text-align:center;margin-top:20px;">毕业生成绩表粘贴处</div>
            </div>
            <div class="table-right table" style="top: 1381px; right: 10px;">
                <div style="text-align:center;margin-top:80px;margin-right:30px;">
                    <img src="/Image/university.png" alt="" /></div>
                <div style="text-align:center;font-size:35px;margin-top:60px;margin-left:80px;">
                     届 毕 业 生 就 业 推 荐 表
                </div>
