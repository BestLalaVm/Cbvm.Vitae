<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterDetail.master" AutoEventWireup="true"
    CodeBehind="ImportStudent.aspx.cs" Inherits="Cbvm.Vitae.Manage.College.ImportStudent" Theme="UniversityManage" %>

<%@ Register Src="~/Manage/College/UserControl/ImportControl.ascx" TagName="ImportControl" TagPrefix="uc" %>
