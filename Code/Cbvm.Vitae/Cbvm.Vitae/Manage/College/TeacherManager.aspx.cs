...
{
    public partial class TeacherManager : BaseCollegeListPage<TeacherPresentation, TeacherCriteria>
    {
        ...
        private CVAcademicianDataContext DataContext
        {
            get
            {
                return ((IOrigianlBaseService)_Service).DataContext;
            }
        }
        ...
        protected void grdTeacher_UpdateCommand(object source, GridCommandEventArgs e)
        {
            if (e.CommandName == "Update")
            {
                ...
                //var drp_DepartCode_ = e.Item.FindControl("drp_DepartCode_") as DropDownList;

                var teacherID = 0;
                if (e.Item.ItemIndex > -1)
                {
                    teacherID = int.Parse(((HiddenField)e.Item.FindControl("hdfKey")).Value);
                }
        ...
        protected void grdTeacher_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            {
                var drp_EducationName_ = e.Item.FindControl("drp_EducationName_") as DropDownList;
                ListBox lstTeacherGroupCode = e.Item.FindControl("lstTeacherGroupCode") as ListBox;
