<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="PunishManage.aspx.cs" Inherits="Cbvm.Vitae.Manage.College.PunishManage" %>
    ...
    <telerik:RadGrid ID="grdActivity" runat="server" OnNeedDataSource="radGrid_NeedDataSource"
        ...
        <MasterTableView DataKeyNames="ID">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Title" HeaderText="惩处名称">
                    <HeaderStyle Width="300px" HorizontalAlign="Left" />
                    <ItemStyle Width="300px" HorizontalAlign="Left" />
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="StudentName" HeaderText="受罚学生">
                ...
                <telerik:GridTemplateColumn>
                    <ItemTemplate>
                        <a href='PunishDetail.aspx?ID=<%#Eval("ID") %>' title="编辑" class="grid-edit">
                            <span>编辑</span>
                        </a>
                    </ItemTemplate>
                </telerik:GridTemplateColumn>
