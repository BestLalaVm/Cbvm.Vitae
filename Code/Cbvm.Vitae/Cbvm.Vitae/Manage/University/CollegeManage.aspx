<%@ Page Title="" Language="C#" MasterPageFile="~/Manage/MasterList.master" AutoEventWireup="true" CodeBehind="CollegeManage.aspx.cs" Inherits="Cbvm.Vitae.Manage.University.CollegeManage" %>
    ...
    <telerik:RadGrid ID="grdTeacherGroup" runat="server" OnItemDataBound="radGrid_ItemDataBound"
        ...
        <MasterTableView DataKeyNames="Code" AllowCustomPaging="True" AllowPaging="True">
            <Columns>
                ...
                <telerik:GridBoundColumn DataField="Description" HeaderText="学院描述">
                    <HeaderStyle HorizontalAlign="Left" Width="200px" />
                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                </telerik:GridBoundColumn>
                ...
                <FormTemplate>
                    <div class="data-detail">
                        ...
                        <div class="container">
                            <table>
                                <tr>
                                    <th valign="top"><span class="required">学院名称</span>:</th>
                                    <td>
                                ...
                                <tr>
                                    <th></th>
                                    <td>
                                        <asp:RequiredFieldValidator runat="server" ID="rqvName" ControlToValidate="txtName" Display="Dynamic" ErrorMessage="<span class='required'>学院名称不能为空</span>"></asp:RequiredFieldValidator></td>
                                </tr>
                                <tr>
                                    <th valign="top">学院描述:</th>
                                    <td>
